...
class SupabaseConfig {
  static bool get isInitialized {
    try {
      ...
      final hasValidUrl = Env.supabaseUrl.isNotEmpty && !Env.supabaseUrl.contains('<your-ref>');
      final hasValidKey = Env.supabaseAnonKey.isNotEmpty && !Env.supabaseAnonKey.contains('<your-anon-public-key>');
