...
echo "   1. Verify: psql -f scripts/dev_verification.sql"
echo "   2. Seed test data: psql -f scripts/dev_seed_data.sql"
echo "   3. Seed meal kits: dart run tools/seed_meals.dart"
echo ""
