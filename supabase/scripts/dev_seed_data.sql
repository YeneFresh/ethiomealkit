...
insert into public.recipes (
    id, name, cuisine, description, image_url, slug, price_cents, kcal,
    tags, chef_note, badges, badges_top3, badges_overflow, 
    protein, protein_label, is_featured, is_active, priority
) values
    (
        gen_random_uuid(),
        'Doro Wat',
        ...
        array['Traditional', 'Spicy', 'High Protein', 'Signature Dish'],
        array['Traditional', 'Spicy', 'High Protein'],
        array['Signature Dish'],
        34, '34 g',
        true, true, 100
    ),
    (
        ...
        array['Vegetarian', 'Traditional', 'Comfort Food', 'Plant Protein'],
        array['Vegetarian', 'Traditional', 'Comfort Food'],
        array['Plant Protein'],
        18, '18 g',
        true, true, 90
    ),
    (
        ...
        array['Quick Cook', 'High Protein', 'Awaze Spice'],
        array['Quick Cook', 'High Protein', 'Awaze Spice'],
        array[],
        28, '28 g',
        false, true, 80
    ...
    (
        ...
        array['Healthy', 'Traditional', 'Iron Rich', 'Slow Cooked'],
        array['Healthy', 'Traditional', 'Iron Rich'],
        array['Slow Cooked'],
        22, '22 g',
        false, true, 70
    ),
    (
        ...
        array['Vegetarian', 'Sampler', 'Variety Pack'],
        array['Vegetarian', 'Sampler', 'Variety Pack'],
        array[],
        15, '15 g',
        true, true, 85
    ...
    (
        ...
        array['Premium', 'Raw Preparation', 'High Protein', 'Specialty'],
        array['Premium', 'Raw Preparation', 'High Protein'],
        array['Specialty'],
        42, '42 g',
        true, true, 95
    )
on conflict (slug) do update set
    ...
    badges_top3 = excluded.badges_top3,
    badges_overflow = excluded.badges_overflow,
    protein = excluded.protein,
    protein_label = excluded.protein_label,
    updated_at = now();
